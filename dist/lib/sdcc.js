...
var awaitReady = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve) {
                ...
                var SDCC = helpers_1.requireUncached("../gbdk/sdcc");
                process.chdir(cwd);
                SDCC.onRuntimeInitialized = function () {
                    resolve(SDCC);
                };
            })];
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                helpers_1.requiredFolders([filename]).forEach(function (f) { return SDCC.FS.mkdir(f); });
                SDCC.FS_createDataFile(".", inFile, file, true, true);
                SDCC.callMain(args);
                SDCC.FS_unlink(inFile);
                return [2 /*return*/, SDCC.FS.readFile(outFile)];
        }
    });
}); };
exports.default = sdcc;
