...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'sdcpp.wast';
  var wasmBinaryFile = 'sdcpp.wasm';
  var asmjsCodeFile = 'sdcpp.temp.asm.js';
...
Module['wasmTableSize'] = 352;

Module['wasmMaxTableSize'] = 352;
